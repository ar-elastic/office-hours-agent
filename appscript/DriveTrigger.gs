// CONFIGURATION
const FOLDER_ID = 'Replace with your google drive folder ID';
const CLOUD_FUNCTION_URL = 'Replace with your cloud function URL';
const BUCKET_NAME = 'Replace with your GCS bucket';
...
function checkNewFiles(shouldReset, scanAllFolders, folderStartsWith) {
  ...
  if (folderStartsWith) {
    ...
    // Case B: Reset Requested -> Scan back 1 days to capture recent missed data
